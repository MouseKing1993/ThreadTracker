    ...
    void transform(@NonNull TransformInvocation transformInvocation) {
        ...
        inputs.each { TransformInput input ->
            ...
            input.jarInputs.each { JarInput jarInput ->
                // com.amber.lib:thread-tracker-plugin:1.0.0
                handleJarInputs(jarInput, outputProvider)
//                println ''+jarInput.name
//                if (jarInput.file.getAbsolutePath().endsWith(".jar") && jarInput.name.startsWith("com.amber.lib:thread-tracker-plugin")) {
//                    int colonIndex = jarInput.name.lastIndexOf(":")
//                    String version = jarInput.name.substring(colonIndex + 1)
//                    if (version != VERSION) {
//                        throw new RuntimeException("version mismatching: please use com.amber.lib:thread-tracker-plugin:" + VERSION)
//                    }
...
//            throw new RuntimeException("can't find threadtracker.jar: please implementation 'com.amber.lib:thread-tracker-plugin:" + VERSION + "' in your application gradle file")
//        }
