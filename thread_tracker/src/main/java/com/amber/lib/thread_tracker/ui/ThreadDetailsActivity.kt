...
import com.amber.lib.thread_tracker.UserPackage
import com.amber.lib.thread_tracker.bean.ShowInfo
import com.amber.lib.thread_tracker.bean.ThreadInfo
import com.amber.lib.thread_tracker.bean.ThreadPoolInfo
...
class ThreadDetailsActivity : Activity() {
    ...
    private lateinit var stack1Details: TextView
    private lateinit var stack1Tips: TextView
    private lateinit var stack1Jump: TextView
    private lateinit var infoTitle: TextView
    private lateinit var stack1Title: TextView
    private lateinit var stack2Details: TextView
    private lateinit var stack2Title: TextView
    private lateinit var infoTitleJump: TextView
    private lateinit var stack1TipsLayout: RelativeLayout
    private lateinit var infoTitleTipsLayout: RelativeLayout
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        stack1Details = findViewById(R.id.stack1Details)
        stack1Tips= findViewById(R.id.stack1Tips)
        stack1Jump = findViewById(R.id.stack1Jump)
        infoTitle = findViewById(R.id.infoTitle)
        stack1Title = findViewById(R.id.stack1Title)
        stack2Details = findViewById(R.id.stack2Details)
        stack2Title = findViewById(R.id.stack2Title)
        infoTitleJump = findViewById(R.id.infoTitleJump)
        stack1TipsLayout = findViewById(R.id.stack1TipsLayout)
        infoTitleTipsLayout = findViewById(R.id.infoTitleTipsLayout)
    ...
    private fun highlightStack(stack0: String): SpannableString {
        ...
        var indexA = -1
        var indexZ = -1
        for (s in UserPackage.packageList) {
